...
**Key relationships**: Required by almost all other map files, defines the fundamental geographic units  
...
**Key relationships**: Requires provinces, relates to railways and supply  
...
**Key relationships**: Requires provinces, conflicts with pre-1.11 supply_areas, relates to strategic regions and railways  
...
**Key relationships**: Foundational knowledge required by heightmap, buildings, and strategic regions  
