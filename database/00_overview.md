...
**Key relationships**: Requires localisation_system, relates to country_leaders, characters, modifiers_list  
...
**Key relationships**: Requires ideas_core, relates to gui_system, sprites, characters  
...
**Key relationships**: Requires localisation_system, relates to country_leaders, ai_peace, factions  
...
**Key relationships**: Requires equipment, buildings, units, relates to ai_focuses, tech_sharing  
...
**Key relationships**: Requires technologies_core, relates to gui_system, sprites  
...
**Key relationships**: Requires technologies_core, relates to units, production, resources, modifiers_list  
...
**Key relationships**: Requires states, provinces, relates to supply, infrastructure, production, technologies_core  
...
**Key relationships**: Requires buildings, production, relates to sprites, trade  
...
**Key relationships**: Requires modifiers_list, decisions, relates to static_modifiers  
...
**Key relationships**: Requires units, ships, relates to oob_files, operatives, localization  
