...
**Key relationships**: Requires triggers, effects, and scopes; relates to localization and on_actions  
...
**Key relationships**: Requires triggers, effects, and modifiers; relates to ideas, ai_strategy, and focus_inlay_windows  
...
**Key relationships**: Requires triggers, effects, and modifiers; relates to states, targeted_decisions, and missions  
...
**Key relationships**: Requires triggers, modifiers, and strategic_regions; relates to divisions, equipment, focuses, and peace_conference  
...
**Key relationships**: Requires triggers; relates to ironman_mode  
...
**Key relationships**: Requires countries, focus_trees, and ideologies; relates to history, difficulty_modifiers, and game_rules  
...
- **countries**: Required by bookmarks (country entries)
- **history**: Required by bookmarks (date execution)
- **strategic_regions**: Required by ai_strategy (AI areas)

### External Relations
- **on_actions**: Relates to events (firing context)
- **localization**: Relates to events, focuses, decisions (loc keys)
- **ideas**: Relates to focuses (continuous focus ideas)
- **divisions**: Relates to ai_strategy (templates)
- **equipment**: Relates to ai_strategy (designs)
- **peace_conference**: Relates to ai_strategy (peace AI)
